...
Color primary = const Color(0xFF9B79B0);
class Styles{
  static Color primaryColor = primary;
  static Color textColor = const Color(0xFF3b3b3b);
  static Color bgColor = const Color(0xFFeeedf2);
  static Color purpleColor = const Color(0xff9363a6);
  static Color greenColor = const Color(0xffa7c274);
  static Color khakiColor = const Color(0xffd5d3bf);
